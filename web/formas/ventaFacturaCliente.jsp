    ...
    <body>
        ...
        if (request.getParameter("guardar") != null)
        {
            ...
            else
            {
                ...
                String SqlInsert = "insert into ventas (cod_cliente,fec_venta) values('"+idCli+"','"+fechaActual+"');";
                if ( control.transaccion(SqlInsert) )
                {
                        String inicio = "SELECT ";
                        String campo = "max(int2(cod_venta))";
                        String fin = " FROM ventas;";
                        int codCompra = Integer.parseInt( control.retornaInt(inicio, campo, fin));
                    for (int i = 0; i < codigo.size(); i++)
                    {
                        String SqlInsertar = "INSERT INTO factura_venta (cod_venta,cod_producto,can_compra) values('"+codCompra+"','"+idProducto.elementAt(i)+"','"+canti.elementAt(i)+"');";
...
<html>
    ...
    <body>
        ...
        <table align="center">
            <tr>
                <td colspan="6" ><center> <b>Factura de venta a Clientes</b> </center> </td>
            </tr>
            <tr>
                <td colspan="3"> Cliente </td>
                <td colspan="1"> <% out.print("<B>" + nomCli + "</B>"); %> </td>
                <td colspan="1"> id </td>
                <td colspan="1"> <% out.print("<B>" + idCli + "</B>"); %> </td>
            </tr>
            <tr>
                <td colspan="3">Vendedor </td><td colspan="3">
                        <%
            ...
            <%
                ...
                for (int i = 0; i < codigo.size(); i++)
                    ...
                    out.print(control.linea(i) + "<td>" + ( i + 1 ) + "</td><td>" + codigo.elementAt(i) + "</td><td>" + val.elementAt(i) + "</td><td>" + canti.elementAt(i) + "</td><td>" + vpar + "</td><td><a href='ventaFacturaCliente.jsp?dato=" + i + "'>Elimnar</a></td></tr>");
                    total += vpar;
                    }
        ...
        <table align="center">
                <tr>
                    <td valign="middle"><A href="ventaImprimir.jsp" target="_blank">Imprimir Factura</A></td>
                    <td valign="middle"><A href="ventaCompraCliente.jsp">Seguir Comprando</A></td>
                    <td valign="middle"><A href="ventaFacturaCliente.jsp?guardar=1">Guardar Factura</A></td>
                </tr>
        </table>
    </body>
</html>